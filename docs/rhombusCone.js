class rhombusCone
{
    ...
    getPoints(){
        return [
            [this.#points[0], this.#points[3], this.#points[4]],
            [this.#points[0], this.#points[4], this.#points[1]],
            [this.#points[0], this.#points[1], this.#points[2]],
            [this.#points[0], this.#points[2], this.#points[3]],
        
            [this.#points[5], this.#points[3], this.#points[4]],
            [this.#points[5], this.#points[4], this.#points[1]],
            [this.#points[5], this.#points[1], this.#points[2]],
            [this.#points[5], this.#points[2], this.#points[3]]
        ]
    }
